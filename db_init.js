...
db.serialize(() => {
  ...
  stmt.run("Audio", "Audio 40 ans FSF", "https://fsf40.billois.org/fsf-40-audio.ogg", 0);
  stmt.run("Texte", "Texte 40 ans FSF", "https://fsf40.billois.org/fsf-40-audio.md", 0);
  stmt.run("PDF", "CV", "https://www.billois.org/cv_sbillois.pdf", 0);
  stmt.run("Page web", "Home page", "https://www.billois.org", 0);
  stmt.finalize();
